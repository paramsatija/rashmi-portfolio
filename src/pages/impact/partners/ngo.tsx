...
const NGOS: PartnerItem[] = [
  { name: "Education Above All", city: "Doha, Qatar", status: "Strategic", blurb: "Global education initiatives through cultural arts programming.", logo: "https://placehold.co/200x120?text=EAA" },
  { name: "Qatar Charity", city: "Doha, Qatar", status: "Long-term", blurb: "Community-focused cultural and educational development programs.", logo: "https://placehold.co/200x120?text=QC" },
  { name: "Reach Out to Asia (ROTA)", city: "Doha, Qatar", status: "Active", blurb: "Cross-cultural programs promoting Asian heritage and understanding.", logo: "https://placehold.co/200x120?text=ROTA" },
  { name: "Al Fakhoora", city: "Doha, Qatar", status: "Active", blurb: "Educational support and cultural development for underserved communities.", logo: "https://placehold.co/200x120?text=Fakhoora" },
];
      ...
      <main className="mx-auto space-y-10 pt-20 pb-16">
        <Section>
          ...
          <p className="max-w-3xl text-black/75">
            Social development and education partners scaling impact across communities through arts and culture.
          </p>
        </Section>
        ...
        <Section>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link href="/impact/partners/cultural" className="rounded-full px-4 py-2 text-white btn-magnetic" style={{ background: soft.accent }}>
              View Cultural Partners <ArrowRight size={16} />
            </Link>
          </div>
        </Section>
      </main>
